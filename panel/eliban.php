...
$( "#tipoTrans" )
  .change(function () {
    var str = "";
    $( "#tipoTrans option:selected" ).each(function() {
      str += $( this ).text() + " ";
    });
    $( "#focusedInput" ).val( str );
  })
  .change();
</script>
...
<div class="navbar">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="/index.php"><span>MeSubo.cl - Eliminar Banner</a>
...
<div id="content">
<form class="form-horizontal" action="eliminar.php?q=5" method="post">
	<fieldset>
	<legend>Complete el formulario:</legend>
	<div class="control-group">
		<label class="control-label" for="selectError3">Nombre banner</label>
		<div class="controls">
		  <select id="tipoTrans" name="banner" required>
