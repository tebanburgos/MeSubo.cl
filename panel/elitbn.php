...
<div class="navbar">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="/panel.php/nimda.php"><span>MeSubo.cl - Eliminar Tipo banner</a>
...
?>
<div id="content">
<form class="form-horizontal" action="eliminar.php?q=7" method="post">	<fieldset>	<legend>Complete el formulario:</legend>

<div class="control-group">		
<label class="control-label" for="selectError3">Seleccione Tipo banner</label>		
<div class="controls">		  
<select id="tipoban" name="tipoban" required>			
