...
<div class="navbar">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="/panel.php/nimda.php"><span>MeSubo.cl - Eliminar Tipo transporte</a>
...
?>
<div id="content">
<form class="form-horizontal" action="eliminar.php?q=8" method="post">	<fieldset>	<legend>Complete el formulario:</legend>

<div class="control-group">		
<label class="control-label" for="selectError3">Seleccione Tipo transporte</label>		
<div class="controls">		  
<select id="tipotra" name="tipotra" required>			
