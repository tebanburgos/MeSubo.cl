...
<div class="navbar">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="/index.php"><span>MeSubo.cl - Modificar Transporte</a>
...
<div id="content">
<form class="form-horizontal" action="modificar.php?q=4" method="post">
	<fieldset>
	<legend>Complete el formulario:</legend>
		...
		<div class="controls">
		  <select id="trans" required name="trans" onchange="obten_datos(this,'tipotrans','servicio','linea','nomdesc');">
	...
	<div class="control-group">
		<label class="control-label" for="selectError3">Tipo transporte</label>
		<div class="controls">
		  <select id="tipotrans" required name="tipotrans">
		  <option value="">Seleccione una opcion</option>
		  <?php 
			$result = mysql_query("SELECT COD_TIPO_TRANSPORTE, TXT_TIPO_TRANSPORTE FROM M_TIPO_TRANSPORTE", $link);
	  ...
	  <div class="control-group">
		...
		<div class="controls">
		  <select id="servicio" required name="servicio">
		  <option value="">Seleccione una opcion</option>
		  <?php 
	  ...
	  <div class="control-group">
		<label class="control-label" for="selectError3">Linea</label>
		<div class="controls">
		  <select id="linea" required name="linea">
		  <option value="">Seleccione una opcion</option>
		  <?php 
			$result = mysql_query("SELECT COD_NUM_LINEA, TXT_LINEA FROM M_LINEA", $link);
	  ...
	  <div class="control-group">		
	  	<label class="control-label" for="nomdesc">Nombre transporte</label>		
	  	<div class="controls">		  
	  	<input class="input-xlarge focused" id="nomdesc" name="nomdesc" type="text" placeholder="Ej: 1 Troncal, 2 Variante, 5 Variante 2, 111 Express">		</div>	  </div>
