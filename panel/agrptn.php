...
<div class="navbar">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="/index.php"><span>MeSubo.cl - Agregar Tipo negocio</a>
...
?>
<div id="content">
<form class="form-horizontal" action="agregar.php?q=8" method="post">
	<fieldset>
	...
	<div class="control-group">
		...
		<div class="controls">
		  <input class="input-xlarge focused" id="focusedInput" required name="nomtiponegocio" type="text" placeholder="Tecnologia, Multi-tiendas, Mayorista, Mecanica">
		</div>
	  </div>
