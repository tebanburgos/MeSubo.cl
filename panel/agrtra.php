...
<div class="navbar">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="/index.php"><span>MeSubo.cl - Agregar Transporte</a>
...
<div id="content">
<form class="form-horizontal" action="agregar.php?q=4" method="post">
	<fieldset>
	...
	<div class="control-group">
		...
		<div class="controls">
		  ...
		  <?php 
			$result = mysql_query("SELECT COD_TIPO_TRANSPORTE, TXT_TIPO_TRANSPORTE FROM M_TIPO_TRANSPORTE WHERE ACTIVO = 1", $link);
	  ...
	  <div class="control-group">
		...
		<div class="controls">
		  <select id="tipoTrans" required name="servicio">
		  <option value="">Seleccione una opcion</option>
		  <?php 
			$result = mysql_query("SELECT COD_SERVICIO, TXT_SERVICIO FROM M_SERVICIO WHERE ACTIVO = 1", $link);
	  ...
	  <div class="control-group">
		...
		<div class="controls">
		  <select id="tipoTrans" required name="linea">
		  <option value="">Seleccione una opcion</option>
		  <?php 
	  ...
	  <div class="control-group">		
	  	<label class="control-label" for="focusedInput">Nombre transporte</label>		
	  	<div class="controls">		  
	  	<input class="input-xlarge focused" id="focusedInput" name="nametrans" type="text" placeholder="Ej: 1 Troncal, 2 Variante, 5 Variante 2, 111 Express">		</div>	  </div>
