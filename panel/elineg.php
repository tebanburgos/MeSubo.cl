...
<div class="navbar">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="/index.php"><span>MeSubo.cl - Eliminar Negocio</a>
...
<div id="content">
<form class="form-horizontal" action="eliminar.php?q=1" method="post">
	<fieldset>
	<legend>Complete el formulario:</legend>
	
	<div class="control-group">
		<label class="control-label" for="selectError3">Seleccionar negocio</label>
		<div class="controls">
		  <select id="tipoTrans" required name="negocio">
			<option value="">Seleccione una opcion</option>
		  <?php 
$result = mysql_query("SELECT COD_NEGOCIO, TXT_NEGOCIO FROM M_NEGOCIO WHERE ACTIVO = 1", $link);
