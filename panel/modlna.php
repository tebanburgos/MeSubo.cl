...
<div class="navbar">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<a class="brand" href="/index.php"><span>MeSubo.cl - Modificar Linea</a>
...
<div id="content">
<form class="form-horizontal" action="modificar.php?q=2" method="post">	

<fieldset>	<legend>Complete el formulario:</legend>

<div class="control-group">		
<label class="control-label" for="selectError3">Seleccione linea</label>		
<div class="controls">		  
<select id="tipoTrans" onChange="asigna(this);" required name="linea">			
...
<div class="controls">		  
<input class="input-xlarge focused" id="focusedInput"  required name="nomlinea" type="text" placeholder="Linea 4, Colectivo 111">		</div>	  </div>	  
...
<div class="form-actions">		<button type="submit" class="btn btn-primary">Modificar</button>		<button type="reset" class="btn">Limpiar</button>	  </div>	</fieldset>  </form></div>
